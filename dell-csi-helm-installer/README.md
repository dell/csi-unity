...
1. Download a template file for the driver to a new location, naming this new file is at the users discretion. The template files are always found at `https://github.com/dell/helm-charts/raw/csi-unity-2.7.0/charts/csi-unity/values.yaml`
...
wget -O my-unity-settings.yaml https://github.com/dell/helm-charts/raw/csi-unity-2.7.0/charts/csi-unity/values.yaml
